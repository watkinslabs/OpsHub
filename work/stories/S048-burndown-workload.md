...
- Rust domain: `crates/domain/src/charts/{burndown.rs, timeline.rs, workload.rs}` and `crates/domain/src/charts/adapters/sheet.rs` (visible-row reads plus `cell_history` day-boundary replay)
