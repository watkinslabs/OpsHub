...
- Capability contract: `docs/capability-contracts.md` rows F026, F063, F048, F064, F065, F027, F028, F029, F030, F047
...
- F048 Entitlements and feature flags: entitlement records per module, flag lifecycle and overrides, the shared RequireModule guard, and the admin surfaces that switch them — foundational to selling, so it precedes billing rather than shipping with the modules it gates (`entitlements` module).
