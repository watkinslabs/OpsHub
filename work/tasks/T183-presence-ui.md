...
parent_story: S092
depends_on: [S092]
owned_paths: [crates/domain/src/realtime/**, crates/persistence/src/realtime/**, services/api/src/realtime/**, services/realtime/src/realtime/**, apps/web/src/features/realtime/**, testing/features/F046/api/**, testing/features/F046/frontend/**]
...
- Fixtures/mocks: mock WebSocket server for Vitest; MSW handlers for changes and sessions; document fixture with snapshot at rev 10, changes to rev 20, and their `document_change_deps` rows
