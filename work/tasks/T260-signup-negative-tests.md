...
- Owner: platform
- Branch: `t260-signup-negative-tests`
- Decision references: `docs/architecture-decisions.md` sections 4, 9; `docs/capability-contracts.md` row F065
...
- Owned paths: `testing/features/F065/{api/negative_tests.rs, api/enumeration_tests.rs, api/race_tests.rs, e2e/signup.spec.ts, e2e/trial_lifecycle.spec.ts, performance/signup_bench.rs, performance/sweep_bench.rs, requirements/cases.md}`
