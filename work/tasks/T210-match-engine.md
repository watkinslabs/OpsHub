...
parent_story: S105
depends_on: [T209]
owned_paths: [crates/domain/src/datamesh/**, services/api/src/datamesh/**, services/worker/src/datamesh/**, testing/features/F053/api/**, testing/features/F053/requirements/**, testing/features/F053/performance/**]
...
- Owner: platform
- Branch: `t210-match-engine`
- Decision references: `docs/architecture-decisions.md` sections 2, 7; `docs/capability-contracts.md` row F053
