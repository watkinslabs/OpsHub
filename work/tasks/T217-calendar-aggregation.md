...
parent_story: S109
depends_on: [S109]
owned_paths: [services/api/migrations/*_calendar-app_*.sql, crates/domain/src/calendar-app/**, services/api/src/calendar-app/**, testing/features/F055/database/**, testing/features/F055/api/**]
...
- Owner: platform
- Branch: `t217-calendar-aggregation`
- Decision references: `docs/architecture-decisions.md` sections 2, 3, 10; `docs/capability-contracts.md` row F055
