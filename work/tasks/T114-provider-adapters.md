...
parent_story: S057
depends_on: [T113]
owned_paths: [crates/domain/src/integrations/**, services/api/src/integrations/**, apps/web/src/features/integrations/**, testing/features/F029/api/**, testing/features/F029/frontend/**]
...
- Owner: platform
- Branch: `t114-provider-adapters`
- Decision references: `docs/architecture-decisions.md` sections 6, 7; `docs/capability-contracts.md` row F029
