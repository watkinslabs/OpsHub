...
parent_story: S126
depends_on: [S126]
owned_paths: [crates/domain/src/entra/**, services/worker/src/entra/**, testing/features/F063/api/**, testing/features/F063/performance/**]
...
- Owner: platform
- Branch: `t251-graph-mail-transport`
- Decision references: `docs/architecture-decisions.md` sections 5, 7; `docs/capability-contracts.md` row F063
...
- Owned paths: `crates/domain/src/entra/{mail.rs, breaker.rs}`; `services/worker/src/entra/{mod.rs, transport.rs}`
