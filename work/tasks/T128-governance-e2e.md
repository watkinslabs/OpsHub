...
- Owner: platform
- Branch: `t128-governance-e2e`
- Decision references: `docs/architecture-decisions.md` sections 4, 9; `docs/capability-contracts.md` row F032
...
- Owned paths: `testing/features/F032/e2e/{governance.spec.ts, intake.spec.ts, governance_permissions.spec.ts}`, `testing/features/F032/performance/governance_bench.rs`, `testing/features/F032/api/permission_tests.rs`, `testing/features/F032/requirements/cases.md`
