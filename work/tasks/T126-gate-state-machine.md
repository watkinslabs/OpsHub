...
parent_story: S063
depends_on: [T125]
owned_paths: [crates/domain/src/governance/**, crates/persistence/src/governance/**, services/api/src/governance/**, services/worker/src/governance/**, testing/features/F032/api/**, testing/features/F032/requirements/**]
...
- Owned paths: `crates/domain/src/governance/{gates.rs, intake.rs, service_gates.rs, service_intake.rs}`, `crates/persistence/src/governance/{stage_gate_repository.rs, decision_repository.rs, intake_repository.rs}`, `services/api/src/governance/{handlers_gates.rs, handlers_intake.rs}`, `services/worker/src/governance/{gate_provisioning.rs, approval_sync.rs, intake_provisioning.rs}`
