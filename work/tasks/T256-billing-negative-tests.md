...
- Owner: platform
- Branch: `t256-billing-negative-tests`
- Decision references: `docs/architecture-decisions.md` sections 4, 9; `docs/capability-contracts.md` row F064
