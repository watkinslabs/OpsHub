...
parent_story: S061
depends_on: [T121]
owned_paths: [crates/domain/src/portfolios/**, crates/persistence/src/portfolios/**, services/api/src/portfolios/**, services/worker/src/portfolios/**, testing/features/F031/api/**, testing/features/F031/requirements/**]
...
- Owner: platform
- Branch: `t122-rollup-projections`
- Decision references: `docs/architecture-decisions.md` sections 2, 2.1, 3, 4, 7; `docs/capability-contracts.md` row F031
...
- Owned paths: `crates/domain/src/portfolios/{mod.rs, portfolio.rs, mappings.rs, rollup.rs, measures.rs, errors.rs, service.rs, service_rollup.rs}`, `services/api/src/portfolios/{mod.rs, routes.rs, handlers_portfolio.rs, handlers_rollup.rs, dto.rs}`, `services/worker/src/portfolios/{mod.rs, refresh_job.rs, scheduler.rs}`, and the named queries added to `crates/persistence/src/portfolios/{portfolio_repository.rs, rollup_repository.rs}` created by T121
