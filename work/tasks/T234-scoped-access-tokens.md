...
parent_story: S117
depends_on: [T233]
owned_paths: [crates/domain/src/publishing/**, services/api/src/publishing/**, testing/features/F059/api/**, testing/features/F059/requirements/**]
...
- Owner: platform
- Branch: `t234-scoped-access-tokens`
- Decision references: `docs/architecture-decisions.md` sections 3, 4; `docs/capability-contracts.md` row F059
...
- Owned paths: `crates/domain/src/publishing/{token.rs, resolve.rs}`, `services/api/src/publishing/{handlers_token.rs, handlers_public.rs}`
