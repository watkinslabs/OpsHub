...
parent_story: S036
depends_on: [S036]
owned_paths: [crates/domain/src/workflows/**, services/api/src/workflows/**, apps/web/src/features/workflows/**, testing/features/F018/api/**, testing/features/F018/frontend/**]
...
- Failing test first: `testing/features/F018/api/publish_tests.rs::publish_writes_immutable_version`, `::patch_after_publish_keeps_version`, `::action_webhook_inline_secret_invalid`, `::placeholder_unknown_column_invalid`, `::sheet_limit_101_conflict`; `testing/features/F018/frontend/WorkflowBuilderPage.test.tsx::builder_publish_disabled_until_valid`, `::shows_denied_read_only_for_viewer`, `ConditionTree.test.tsx::nested_groups_expose_aria_level`, `ActionList.test.tsx::keyboard_reorder_updates_indexes`
