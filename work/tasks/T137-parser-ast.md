...
- Owned paths: `crates/domain/src/formulas/{mod.rs, lexer.rs, parser.rs, ast.rs, canonical.rs, errors.rs, schema.rs}`, `services/api/migrations/<ts>_formulas_create_tables.sql`, `services/api/migrations/<ts>_formulas_create_tables.down.sql`
