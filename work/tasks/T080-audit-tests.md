...
- Failing test first: `testing/features/F020/frontend/DecideDialog.test.tsx::reject_dialog_requires_reason`, `ApprovalDetailPage.test.tsx::decide_rolls_back_on_conflict`, `::non_approver_sees_read_only`; `testing/features/F020/e2e/approvals.spec.ts::request_from_row_and_approve_from_inbox`, `::reject_with_reason_records_audit`, `::reassign_records_audit_and_notifies`, `::overdue_escalates_to_manager`; `testing/features/F020/accessibility/approvals.a11y.spec.ts::inbox_and_detail_have_no_serious_axe_violations`; `testing/features/F020/performance/inbox_bench.rs::inbox_100k_p95`, `sweep_bench.rs::sweep_10k_timers_under_60s`
