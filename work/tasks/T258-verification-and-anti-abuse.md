...
owned_paths: [crates/domain/src/signup/**, crates/persistence/src/signup/**, services/api/src/signup/**, apps/web/src/features/signup/**, testing/features/F065/api/**, testing/features/F065/frontend/**, testing/features/F065/accessibility/**]
...
- Owner: platform
- Branch: `t258-verification-and-anti-abuse`
- Decision references: `docs/architecture-decisions.md` sections 2, 2.1, 3, 4, 6; `docs/capability-contracts.md` row F065
...
- Owned paths: `crates/domain/src/signup/{risk.rs, bot_check.rs, mx.rs, mail.rs, disposable_domains.txt}`, `services/api/src/signup/handlers_public.rs` rejection path and the constant-time floor, and the `RiskFlag` mapping used against `crates/persistence/src/signup/request_repository.rs` (created and owned by T257; this task adds no second writer of `signup_request_risk_flags`), `apps/web/src/features/signup/{SignupPage.tsx, SignupForm.tsx, TurnstileField.tsx, HoneypotField.tsx, VerifySentPage.tsx, SlugField.tsx, ExpiredTokenPage.tsx, InvitationForm.tsx, api.ts, hooks.ts, routes.ts}`
